...
import 'package:we_watch_app/desired_job_details.dart';
...
//                    setPersonalData();
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => DesiredJob()),
                );
        ...
        children: <Widget>[
          Expanded(
            child: new TextField(
              ...
              decoration: new InputDecoration(hintText: 'Certification name'),
            ),
          ),
          SizedBox(
            width: 5,
