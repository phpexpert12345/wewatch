                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Padding(
                                          ...
                                          child: Align(
                                            child: new Text(
                                              (!["", null, false, 0,].contains(cellModel.channel_name)) ? cellModel.channel_name : "Video title",
                                              style: TextStyle(
                                        ...
                                        Padding(
                                          ...
                                          child: Align(
                                            child: new Text(
                                              (!["", null, false, 0,].contains(cellModel.channel_description)) ? cellModel.channel_description : "Video title",
                                              style: TextStyle(
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    onTap: (){
                                      addSubscriber(cellModel.id.toString());
                                    },
                                    child: Padding(
                                      padding: const EdgeInsets.fromLTRB(
                                          0, 10, 20, 10),
...
//                                      width: SizeConfig.widthMultiplier*3, // width of the button
                                          child: Center(
                                              child: Row(
                                                mainAxisAlignment:
                                                MainAxisAlignment
...
//              ),
  ...
  Future addSubscriber(String channelId) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
