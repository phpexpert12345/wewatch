...
class DesiredJob extends StatefulWidget {
  @override
  _DesiredJobState createState() => new _DesiredJobState();
}
...
//                                      ),
                                      new TextField(
                                        ...
                                        decoration: new InputDecoration(
                                          hintText: 'Desired funtional area',
                                          hintStyle:  TextStyle(
                                      ...
                                      Row(
                                        children: <Widget>[
                                          ...
                                          new Expanded(child: Text(
                                            'No, I am not interested in a shifted based job',
                                            style: TextStyle(
